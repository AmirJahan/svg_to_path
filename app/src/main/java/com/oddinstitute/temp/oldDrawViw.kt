...
class oldDrawView : View
{
    ...
    constructor(context: Context?, polygonArray: ArrayList<Polygon>) : super(context)
    {
    ...
    override fun onDraw(canvas: Canvas)
    {
        ...
        for (eachInternalPolygon in polygonArr)
        {
            ...
            // control lines
            makeGuidelinesForControlPoints(eachInternalPolygon)
            mainPaint.style = Paint.Style.STROKE
