...
fun convertSinglePathDataToPolygon(singlePathPieceString: String): Polygon
{
    ...
    for (piece in piecesStringArr)
    {
        when (piece[0])
        {
            ...
            'S' ->
            {
                ...
                {
                    smooth.cp1 = PointF(piecesPathsArr.last().knot.x, piecesPathsArr.last().knot.y)
                }
            ...
            'T' ->
            {
                ...
                {
                    smoothQ.cp1 = PointF(piecesPathsArr.last().knot.x, piecesPathsArr.last().knot.y)
                }
